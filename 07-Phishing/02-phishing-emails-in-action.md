...
![alt text](email1-url-shortener.png)
...
Q1 What phrase does the gibberish sender email start with?
...
![alt text](email2-hyperlinks.png)
...
Q1 What is the root domain for each URL? Defang the URL. 
...
Q1 This email sample used the names of a few major companies, their products, and logos such as OneDrive and Adobe. What other company name was used in this phishing email?
...
Q1 What should users do if they receive a suspicious email or text message claiming to be from Netflix?

A1 forward the message to phishing@netflix.com
...
![alt text](email5-attachment.png)
...
![alt text](email5-attachment2.png)
...
A1 Blind Carbon Copy

Q2 What technique was used to persuade the victim to not ignore the email and act swiftly?
...
![alt text](email4-body-1.png)

![alt text](email4-body-2.png)
