...
![alt text](66264cef7bba67a6bbbe7179-1718813538019.png)
...
<tbody>
<tr>
<td><span style="text-align:left;font-family:'Source Sans Pro'">Windows.cmdline</span></td>
<td>Lists process command line arguments</span></td>
</tr>
<tr>
<td><span style="text-align:left">windows.drivermodule</span></td>
<td>Determines if any loaded drivers were hidden by a rootkit</span></td>
</tr>
<tr>
<td><span style="text-align:left">Windows.filescan</span></td>
<td>Scans for file objects present in a particular Windows memory image</span></td>
</tr>
<tr>
<td><span style="text-align:left">Windows.getsids</span></td>
<td>Print the SIDs owning each process</span></td>
</tr>
<tr>
<td><span style="text-align:left">Windows.handles</span></td>
<td>Lists process open handles</td>
</tr>
<tr>
<td><span style="text-align:left">Windows.info</span></td>
<td>Show <span data-testid="glossary-term" class="glossary-term">OS</span> &amp; kernel details of the memory sample being analyzed</td>
</tr>
<tr>
<td>Windows.netscan</td>
<td>Scans for network objects present in a particular Windows memory image</td>
</tr>
<tr>
<td>Widnows.netstat</td>
<td>Traverses network tracking structures present in a particular Windows memory image.</td>
</tr>
<tr>
<td><span style="text-align:left">Windows.mftscan</span></td>
<td>Scans for Alternate Data Stream</span></td>
</tr>
<tr>
<td><span style="text-align:left">Windows.pslist</span></td>
<td>Lists the processes present in a particular Windows memory image</td>
</tr>
<tr>
<td><span style="text-align:left">Windows.pstree</span></td>
<td>List processes in a tree based on their parent process ID</td>
</tr>
</tbody>
</table>
...
Q1 Which plugin can help us to get information about the OS running on the target machine?

A1 Windows.info

Q2 Which tool referenced above can help us take a memory dump on a Linux OS?

A2 LIME

Q3 Which command will display the help menu using Volatility on the target machine?
...
Q1 Is the architecture of the machine x64 (64bit) Y/N?

A1 Y

Q2 What is the Verison of the Windows OS
...
![alt text](66264cef7bba67a6bbbe7179-1716994189281.png)
...
![alt text](66264cef7bba67a6bbbe7179-1716994189699.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718813719752.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718997024575.png)
...
Q1 Using the plugin "windows.netscan". Can you identify the destination IP address where a connection is established on port 80?

A1 192.168.182.128

![alt text](image-150.png)

Q2 Using the plugin "windows.netscan," can you identify the program (owner) used to access through port 80?

A2 msedge.exe

see image above

Q3 Analyzing the processes present on the dump, what is the PID of the child process of critical_updat?

A3 1612

Q4 What is the time stamp time for the process with the truncated name critical_updat?

A4 2024-02-24 22:51:50.000000
...
![alt text](66264cef7bba67a6bbbe7179-1718810458883.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718810459624.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718811341324.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718811341816.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718811342193.png)
...
![alt text](66264cef7bba67a6bbbe7179-1718811342931.png)
...
Q1 Analyzing the "windows.filescan" output, what is the full path and name for critical_updat?

A1 C:\Users\user01\Documents\critical_update.exe

![alt text](image-151.png)

Q2 Analyzing the "windows.mftscan.MFTScan" what is the Timestamp for the created date of important_document.pdf?

A2 2024-02-24 20:39:42.000000

![alt text](image-154.png)

Q3 Analyzing the updater.exe memory output, can you observe the HTTP request and determine the server used by the attacker?

A3 SimpleHTTP/0.6 Python/3.10.4
